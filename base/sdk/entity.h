...
{
public:
	#pragma region DT_FogController
	N_ADD_VARIABLE(bool, Enable, "CFogController->m_fog.enable");
	N_ADD_VARIABLE(bool, Blend, "CFogController->m_fog.blend");
	N_ADD_VARIABLE(Vector, DirPrimary, "CFogController->m_fog.dirPrimary");
	N_ADD_VARIABLE(int, ColorPrimary, "CFogController->m_fog.colorPrimary");
	N_ADD_VARIABLE(int, ColorSecondary, "CFogController->m_fog.colorSecondary");
	N_ADD_VARIABLE(float, Start, "CFogController->m_fog.start");
...
{
public:
	#pragma region DT_CFish
	N_ADD_VARIABLE(float, X, "CFish->m_x");
	N_ADD_VARIABLE(float, Y, "CFish->m_y");
	N_ADD_VARIABLE(float, Z, "CFish->m_z");
};
