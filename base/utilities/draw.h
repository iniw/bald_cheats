...
namespace F
{
	...
	inline ImFont* Icons;
	// 4    visuals	    14      monochrome and monohinting
	inline ImFont* SegoeUI;
	// 4    visuals	    14      monochrome and monohinting
	inline ImFont* SegoeUI40;
	// 5    visuals	    12      monochrome and monohinting
...
namespace ImGui
{
	...
	bool ColorCheckbox(const char* szLabel, bool* v, Color* c);
