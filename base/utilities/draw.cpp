...
bool ImGui::ColorCheckbox(const char* szLabel, bool* v, Color* col)
{
...
void D::Setup(IDirect3DDevice9* pDevice, unsigned int uFontFlags)
{
	 ...
	 *	accent 2 (darker) - darkviolet: 75,50,105
	 */

	Color primtv1 = Color(20, 20, 30, 255);
	Color primtv3 = Color(10, 10, 20, 255);

	Color accent0 = Color(232, 80, 90, 255);
	Color accent1 = Color(185, 64, 72, 255);
	Color accent3 = Color(139, 48, 54, 255);
	...
	style.Colors[ImGuiCol_TextSelectedBg] = ImVec4(accent1.rBase(), accent1.gBase(), accent1.bBase(), 1.00f);			// accent 1

	style.Colors[ImGuiCol_WindowBg] = ImVec4(primtv3.rBase(), primtv3.gBase(), primtv3.bBase(), 1.00f);				// primtv 3
	style.Colors[ImGuiCol_ChildBg] = ImVec4(primtv1.rBase(), primtv1.gBase(), primtv1.bBase(), 0.50f);				// primtv 1
	style.Colors[ImGuiCol_PopupBg] = ImVec4(primtv1.rBase(), primtv1.gBase(), primtv1.bBase(), 1.00f);				// primtv 1

	style.Colors[ImGuiCol_Border] = ImVec4(accent0.rBase(), accent0.gBase(), accent0.bBase(), 0.1f);					// primtv 4
	style.Colors[ImGuiCol_BorderShadow] = ImVec4(0.00f, 0.00f, 0.00f, 0.00f);			// clear

	style.Colors[ImGuiCol_FrameBg] = ImVec4(primtv1.rBase(), primtv1.gBase(), primtv1.bBase(), 1.00f);				// primtv 3
	style.Colors[ImGuiCol_FrameBgHovered] = ImVec4(accent1.rBase(), accent1.gBase(), accent1.bBase(), 1.00f);			// accent 1
	style.Colors[ImGuiCol_FrameBgActive] = ImVec4(accent0.rBase(), accent0.gBase(), accent0.bBase(), 1.00f);			// accent 0

	style.Colors[ImGuiCol_ControlBg] = ImVec4(primtv1.rBase(), primtv1.gBase(), primtv1.bBase(), 1.00f);				// primtv 3
	...
	style.Colors[ImGuiCol_TitleBg] = ImVec4(accent0.rBase(), accent0.gBase(), accent0.bBase(), 1.00f);				// accent 0
	style.Colors[ImGuiCol_TitleBgActive] = ImVec4(accent1.rBase(), accent1.gBase(), accent1.bBase(), 1.00f);			// accent 1
	style.Colors[ImGuiCol_TitleBgCollapsed] = ImVec4(accent1.rBase(), accent1.gBase(), accent1.bBase(), 1.00f);		// accent 1

	style.Colors[ImGuiCol_MenuBarBg] = ImVec4(primtv1.rBase(), primtv1.gBase(), primtv1.bBase(), 1.00f);				// primtv 1

	style.Colors[ImGuiCol_ScrollbarBg] = ImVec4(primtv3.rBase(), primtv3.gBase(), primtv3.bBase(), 1.00f);			// primtv 3
	style.Colors[ImGuiCol_ScrollbarGrab] = ImVec4(accent3.rBase(), accent3.gBase(), accent3.bBase(), 1.00f);			// accent 3
	...
	style.Colors[ImGuiCol_CheckMark] = ImVec4(accent0.rBase(), accent0.gBase(), accent0.bBase(), 1.00f);				// accent 0

	style.Colors[ImGuiCol_SliderGrab] = ImVec4(accent0.rBase(), accent0.gBase(), accent0.bBase(), 1.00f);				// accent 0
	style.Colors[ImGuiCol_SliderGrabActive] = ImVec4(accent1.rBase(), accent1.gBase(), accent1.bBase(), 1.00f);		// accent 1

	style.Colors[ImGuiCol_Button] = ImVec4(primtv3.rBase(), primtv3.gBase(), primtv3.bBase(), 1.00f);					// primtv 3
	style.Colors[ImGuiCol_ButtonHovered] = ImVec4(0.30f, 0.30f, 0.30f, 1.00f);			// primtv 5
	style.Colors[ImGuiCol_ButtonActive] = ImVec4(accent0.rBase(), accent0.gBase(), accent0.bBase(), 1.00f);			// accent 0

	style.Colors[ImGuiCol_Header] = ImVec4(accent0.rBase(), accent0.gBase(), accent0.bBase(), 1.00f);					// accent 0
	style.Colors[ImGuiCol_HeaderHovered] = ImVec4(0.30f, 0.30f, 0.30f, 1.00f);			// primtv 5
	style.Colors[ImGuiCol_HeaderActive] = ImVec4(primtv3.rBase(), primtv3.gBase(), primtv3.bBase(), 1.00f);			// primtv 3

	style.Colors[ImGuiCol_Separator] = ImVec4(accent0.rBase(), accent0.gBase(), accent0.bBase(), 1.00f);				// primtv 3
	style.Colors[ImGuiCol_SeparatorHovered] = ImVec4(0.30f, 0.30f, 0.30f, 1.00f);		// primtv 5
	style.Colors[ImGuiCol_SeparatorActive] = ImVec4(accent0.rBase(), accent0.gBase(), accent0.bBase(), 1.00f);		// accent 0

	style.Colors[ImGuiCol_ResizeGrip] = ImVec4(accent0.rBase(), accent0.gBase(), accent0.bBase(), 1.00f);				// accent 0
	style.Colors[ImGuiCol_ResizeGripHovered] = ImVec4(0.30f, 0.30f, 0.30f, 0.70f);		// primtv 5
	style.Colors[ImGuiCol_ResizeGripActive] = ImVec4(accent1.rBase(), accent1.gBase(), accent1.bBase(), 1.00f);		// accent 1

	style.Colors[ImGuiCol_Tab] = ImVec4(primtv1.rBase(), primtv1.gBase(), primtv1.bBase(), 1.00f);					// primtv 1
	style.Colors[ImGuiCol_TabHovered] = ImVec4(0.30f, 0.30f, 0.30f, 0.80f);				// primtv 5
	style.Colors[ImGuiCol_TabActive] = ImVec4(accent0.rBase(), accent0.gBase(), accent0.bBase(), 1.00f);				// accent 0
	style.Colors[ImGuiCol_TabUnfocused] = ImVec4(0.30f, 0.30f, 0.30f, 0.70f);			// primtv 5
	style.Colors[ImGuiCol_TabUnfocusedActive] = ImVec4(accent0.rBase(), accent0.gBase(), accent0.bBase(), 1.00f);		// accent 0

	style.Colors[ImGuiCol_PlotLines] = ImVec4(accent0.rBase(), accent0.gBase(), accent0.bBase(), 1.00f);				// accent 0
	style.Colors[ImGuiCol_PlotLinesHovered] = ImVec4(accent0.rBase(), accent0.gBase(), accent0.bBase(), 1.00f);		// accent 0
	style.Colors[ImGuiCol_PlotHistogram] = ImVec4(accent0.rBase(), accent0.gBase(), accent0.bBase(), 1.00f);			// accent 0
	style.Colors[ImGuiCol_PlotHistogramHovered] = ImVec4(accent0.rBase(), accent0.gBase(), accent0.bBase(), 1.00f);	// accent 0

	style.Colors[ImGuiCol_DragDropTarget] = ImVec4(accent3.rBase(), accent3.gBase(), accent3.bBase(), 1.00f);			// accent 3
	style.Colors[ImGuiCol_Triangle] = ImVec4(accent0.rBase(), accent0.gBase(), accent0.bBase(), 1.00f);				// accent 0

	style.Colors[ImGuiCol_ModalWindowDimBg] = ImVec4(accent0.rBase(), accent0.gBase(), accent0.bBase(), 0.1f);		// primtv 4
#pragma endregion
	...
	imVerdanaConfig.RasterizerFlags = ImGuiFreeType::ForceAutoHint;
	F::Verdana = io.Fonts->AddFontFromFileTTF(XorStr("C:\\Windows\\Fonts\\verdanab.ttf"), 14.f, &imVerdanaConfig, io.Fonts->GetGlyphRangesCyrillic());
	...
	imIconsConfig.RasterizerFlags = ImGuiFreeType::ForceAutoHint;
	...
	imSegoeUI40Config.RasterizerFlags = ImGuiFreeType::ForceAutoHint;
	F::SegoeUI40 = io.Fonts->AddFontFromFileTTF(XorStr("C:\\Windows\\Fonts\\segoeuib.ttf"), 40.f, &imSegoeUI40Config, io.Fonts->GetGlyphRangesCyrillic());

	ImFontConfig imRobotoConfig;
	imRobotoConfig.RasterizerFlags = ImGuiFreeType::ForceAutoHint;
	F::Roboto = io.Fonts->AddFontFromMemoryCompressedTTF(roboto_medium_compressed_data, roboto_medium_compressed_size, 10.f, &imRobotoConfig, io.Fonts->GetGlyphRangesCyrillic());
...
void D::RenderDrawData(ImDrawList* pDrawList)
{
	...
	for (const auto& data : vecSafeDrawData)
	{
		...
		case EDrawType::LINE:
		{
			pDrawList->AddLine(ImVec2(round(data.vecFirst.x), round(data.vecFirst.y)), ImVec2(round(data.vecSecond.x), round(data.vecSecond.y)), data.colFirst, data.flThickness);
			break;
		}
		case EDrawType::RECT:
		{
			if (data.iFlags & IMGUI_RECT_FILLED)
				pDrawList->AddRectFilled(ImVec2(round(data.vecFirst.x), round(data.vecFirst.y)), ImVec2(round(data.vecSecond.x), round(data.vecSecond.y)), data.colFirst, data.flRounding, data.roundingCorners);
			else
				pDrawList->AddRect(ImVec2(round(data.vecFirst.x), round(data.vecFirst.y)), ImVec2(round(data.vecSecond.x), round(data.vecSecond.y)), data.colFirst, data.flRounding, data.roundingCorners, data.flThickness);

			if (data.iFlags & IMGUI_RECT_BORDER)
				pDrawList->AddRect(ImVec2(round(data.vecFirst.x), round(data.vecFirst.y)) + ImVec2(1.0f, 1.0f), ImVec2(round(data.vecSecond.x), round(data.vecSecond.y)) - ImVec2(1.0f, 1.0f), data.colSecond, data.flRounding, data.roundingCorners, 1.0f);
		...
		{
			pDrawList->AddRectFilledMultiColor(ImVec2(round(data.vecFirst.x), round(data.vecFirst.y)), ImVec2(round(data.vecSecond.x), round(data.vecSecond.y)), data.colFirst, data.colSecond, data.colThird, data.colFourth);
			break;
		}
		case EDrawType::CIRCLE:
		{
			if (data.iFlags & IMGUI_CIRCLE_FILLED)
				pDrawList->AddCircleFilled(ImVec2(round(data.vecFirst.x), round(data.vecFirst.y)), data.flRadius, data.colFirst, data.nSegments);
			else
				pDrawList->AddCircle(ImVec2(round(data.vecFirst.x), round(data.vecFirst.y)), data.flRadius, data.colFirst, data.nSegments, data.flThickness);

			if (data.iFlags & IMGUI_CIRCLE_OUTLINE)
				pDrawList->AddCircle(ImVec2(round(data.vecFirst.x), round(data.vecFirst.y)), data.flRadius + 1.0f, data.colSecond, data.nSegments, 1.0f);
		...
		case EDrawType::TRIANGLE:
		{
			if (data.iFlags & IMGUI_TRIANGLE_FILLED)
				pDrawList->AddTriangleFilled(ImVec2(round(data.vecFirst.x), round(data.vecFirst.y)), ImVec2(round(data.vecSecond.x), round(data.vecSecond.y)), data.vecThird, data.colFirst);
			else
				pDrawList->AddTriangle(ImVec2(round(data.vecFirst.x), round(data.vecFirst.y)), ImVec2(round(data.vecSecond.x), round(data.vecSecond.y)), data.vecThird, data.colFirst, data.flThickness);

			if (data.iFlags & IMGUI_TRIANGLE_OUTLINE)
				pDrawList->AddTriangle(ImVec2(round(data.vecFirst.x), round(data.vecFirst.y)), ImVec2(round(data.vecSecond.x), round(data.vecSecond.y)), data.vecThird, data.colSecond, 2.0f);
		...
		case EDrawType::TEXT:
		{
			...
			if (data.iFlags & IMGUI_TEXT_DROPSHADOW)
				pDrawList->AddText(data.pFont, data.flFontSize, ImVec2(ImVec2(round(data.vecFirst.x), round(data.vecFirst.y)) - ImVec2(-1.0f, -1.0f)), data.colSecond, data.szText.data());
			else if (data.iFlags & IMGUI_TEXT_OUTLINE)
			{
				pDrawList->AddText(data.pFont, data.flFontSize, ImVec2(round(data.vecFirst.x) - 1.0f, round(data.vecFirst.y)), data.colSecond, data.szText.data());
				pDrawList->AddText(data.pFont, data.flFontSize, ImVec2(round(data.vecFirst.x) + 1.0f, round(data.vecFirst.y)), data.colSecond, data.szText.data());
				pDrawList->AddText(data.pFont, data.flFontSize, ImVec2(round(data.vecFirst.x), round(data.vecFirst.y) - 1.0f), data.colSecond, data.szText.data());
				pDrawList->AddText(data.pFont, data.flFontSize, ImVec2(round(data.vecFirst.x), round(data.vecFirst.y) + 1.0f), data.colSecond, data.szText.data());
				pDrawList->AddText(data.pFont, data.flFontSize, ImVec2(round(data.vecFirst.x) - 1.0f, round(data.vecFirst.y) - 1.0f), data.colSecond, data.szText.data());
				pDrawList->AddText(data.pFont, data.flFontSize, ImVec2(round(data.vecFirst.x) - 1.0f, round(data.vecFirst.y) + 1.0f), data.colSecond, data.szText.data());
				pDrawList->AddText(data.pFont, data.flFontSize, ImVec2(round(data.vecFirst.x) + 1.0f, round(data.vecFirst.y) + 1.0f), data.colSecond, data.szText.data());
				pDrawList->AddText(data.pFont, data.flFontSize, ImVec2(round(data.vecFirst.x) + 1.0f, round(data.vecFirst.y) - 1.0f), data.colSecond, data.szText.data());
			}

			pDrawList->AddText(data.pFont, data.flFontSize, ImVec2(round(data.vecFirst.x), round(data.vecFirst.y)), data.colFirst, data.szText.data());
